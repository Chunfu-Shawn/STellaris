    ...
    return(
        <div className="modal-body-stw" style={contentStyle}>
            ...
            <Typography style={{marginTop:50,fontSize:16}}>
                ...
                <p>Go to the home page or Mapping page (from the navigator bar), and submit a job following the next steps:</p>
                ...
                <ul>
                    ...
                    <li>Select candidate ST sections matching your scRNA-seq by specifying &quot;Species&quot;,
                        &quot;Organ&quot; and &quot;Tissue&quot;. This step is crucial that only the ST sections fitting into
                ...
                <p>
                    ...
                    and navigate to<b> dataset browser </b>of the ST dataset that you are interested in for further information. Once
                ...
                <p>
                    Here we select the top-ranked ST section, which was generated from the coronal plane of the fetal mouse
                    brain at E14.5 using Stereo-seq by our own lab (
                ...
                <p>
                    A confirming dialog will pop up when you click the &quot;select&quot; button and you can set the advanced
                ...
                <p>
                    ...
                    single cells. Please be patient, and you can leave aside the running page and should remember to come
                    back later.
                </p>
