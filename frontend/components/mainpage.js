            ...
            <div className="cover-container">
                <div className="inner cover" >
                    ...
                    <p className="lead" style={{textAlign: "justify"}}>
                        STellaris is an integrated web application for accurate spatial mapping for scRNA-seq data,
                        which is based on a comprehensive compilation of public spatial transcriptome (ST)
            ...
            <div className="modal-body-stw" style={{paddingTop:50}}>
                ...
                <Row style={{margin:"20px 0px"}} gutter={[40,0]} justify="space-between" >
                    <PlaceHolder title={"Spatial Mapping"}
                                 context={"The key module designed for accurate spatial mapping for scRNA-seq data " +
                                     "based on best matched spatial transcriptome data."}
                                 link={"/mapping"} pic={"Pic2.png"}/>
                    <PlaceHolder title={"Dataset Browser"}
                                 context={"Dataset browser contains modules of meta information, basic visualization and " +
