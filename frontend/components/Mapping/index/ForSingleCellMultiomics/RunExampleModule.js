...
export default function RunExampleModule(props){
    ...
    const items=[
            ...
            label: (
                <Button type={"link"}>
                    <a href={"/mapping/resultPage/5a1a39a0-923a-11ed-bff4-0302d4a3355f"}>
                        <span>
                            H3K27me3 modifications in mouse brain <b><i>(FINISHED)</i></b>
                        </span>
                    </a>
                </Button>
            ),
        },
        {
            key: '2',
            label: (
                <Button type={"link"} onClick={throttle(1000,onRunExample("H3K27me3 modifications in mouse adult cortex and hippocampus"))}>
                    <span>
                        H3K27me3 modifications in mouse brain <b><i>(FROM SCRATCH)</i></b>
                    </span>
                </Button>
            ),
        }
